...
curl -Ls https://raw.githubusercontent.com/mbadolato/iTerm2-Color-Schemes/refs/heads/master/tools/import-scheme.sh > "${TEMP_DIR}/tools/import-scheme.sh"
...
do
  ...
  curl -Ls "https://raw.githubusercontent.com/catppuccin/iterm/refs/heads/main/colors/catppuccin-${f}.itermcolors" > "${TEMP_DIR}/schemes/catppuccin-${f}.itermcolors"
  echo "Processing catppuccin-${f}.itermcolors file..."
  # Import file $f
  sh "${TEMP_DIR}/tools/import-scheme.sh" "${TEMP_DIR}/schemes/catppuccin-${f}.itermcolors"
done
